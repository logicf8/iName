...
function renderList() {
  ...
  if (selectedLi) {
    ...
    editText.value = displayArray[currentIndex];
  }
...
editText.addEventListener('input', () => {
  ...
  displayArray[currentIndex] = text;
